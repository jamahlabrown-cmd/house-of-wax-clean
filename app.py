...
APP_VERSION='V25.43.144 FIX: LISTING CARD PRICE NO LONGER TRUNCATES TO "$..."'
...
INSERT_ONLY_NO_READBACK_TABLES={'tester_feedback','listing_reports','support_requests','release_photo_library'}
