...
APP_VERSION='V25.43.109 RENAME: MY PURCHASE REQUESTS IS NOW MY ORDERS'
...
def buyer_workspace_tabs(bid):
    ...
    if b is None:
        ...
        return
    tabs=st.tabs(['My Profile','My Inquiries','My Orders','My Want List'])
    with tabs[0]:
