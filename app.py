...
APP_VERSION='V25.43.133 FIX: LISTING CARD ACTION BUTTONS NO LONGER WRAP INTO TALL STACKED BUTTONS ON DESKTOP'
...
INSERT_ONLY_NO_READBACK_TABLES={'tester_feedback','listing_reports'}
...
def setup():
    ...
    cur.execute("""CREATE TABLE IF NOT EXISTS knowledge_posts(id INTEGER PRIMARY KEY AUTOINCREMENT,title TEXT,category TEXT,audience TEXT,level TEXT,summary TEXT,body TEXT,house_tip TEXT,image_url TEXT,video_url TEXT,status TEXT DEFAULT 'Draft',featured TEXT DEFAULT 'No',source_type TEXT DEFAULT 'Manual',sources TEXT,created_at TEXT,updated_at TEXT)""")
    ...
    c.commit(); c.close()
    mig={'app_users':{'auth_user_id':'TEXT','email':'TEXT','display_name':'TEXT','account_type':'TEXT','buyer_id':'INTEGER','seller_id':'INTEGER','seller_application_status':'TEXT','admin_access':'TEXT','account_status':'TEXT','status':'TEXT','local_password_hash':'TEXT','created_at':'TEXT','updated_at':'TEXT'},'buyers':{'state':'TEXT','bio':'TEXT','avatar_url':'TEXT','status':'TEXT','rating':'REAL','completed_purchases':'INTEGER','unpaid_orders':'INTEGER'},'sellers':{'state':'TEXT','website':'TEXT','instagram':'TEXT','seller_story':'TEXT','specialties':'TEXT','logo_url':'TEXT','banner_url':'TEXT','status':'TEXT','seller_level':'TEXT','rating':'REAL','completed_sales':'INTEGER','auction_override':'TEXT','access_code':'TEXT','contact_preference':'TEXT','rules_accepted':'TEXT','rules_accepted_at':'TEXT','paypal_link':'TEXT'},'products':{'sku':'TEXT','barcode':'TEXT','catalog_number':'TEXT','matrix_runout':'TEXT','label':'TEXT','release_year':'TEXT','video_url':'TEXT','audio_url':'TEXT','external_release_url':'TEXT','listing_status':'TEXT','listing_type':'TEXT','reviewer_notes':'TEXT','reference_image_url':'TEXT'},'feedback':{'public':'TEXT'},'listing_reports':{'listing_id':'INTEGER','seller_id':'INTEGER','reporter_name':'TEXT','reporter_contact':'TEXT','reason':'TEXT','details':'TEXT','status':'TEXT','created_at':'TEXT','updated_at':'TEXT'},'knowledge_posts':{'video_url':'TEXT','source_type':"TEXT DEFAULT 'Manual'",'sources':'TEXT'},'homepage_blocks':{'video_url':'TEXT'},'purchase_requests':{'counter_price':'REAL','counter_message':'TEXT','payment_due_at':'TEXT'},'newsletter_signups':{'interest':'TEXT','updated_at':'TEXT'},'culture_posts':{'seller_id':'INTEGER'}}
...
def seller_listings_manager(sid, key_prefix='seller_listings'):
    ...
    if visible_prods.empty:
        ...
        return
    cols=[c for c in ['id','title','artist','price','quantity','listing_status','Photos','Possible duplicate','created_at','reviewer_notes'] if c in visible_prods.columns]
